...
parser.add_argument("-m", "--model-path",
                    dest="model_path",
                    help="Optional model path. Note that this path starts in bots/ml_on_rand/ instead of the base folder, like dset_path above.",
                    default="model.pkl")
...
if options.train:
    ...
    joblib.dump(model, "./bots/ml_on_rand/" + options.model_path)
